...
print('Portfolio ATL: $', min.__round__(2), ' - at: ', datetime.fromtimestamp(date_1 / 1000).strftime("%d/%m/%Y %H:%M"))
print('Portfolio ATH: $', max.__round__(2), ' - at: ', datetime.fromtimestamp(date_2 / 1000).strftime("%d/%m/%Y %H:%M"))
print('Final portfolio balance: $', trades[-1]['balance'].__round__(2), ' - at: ', datetime.fromtimestamp(trades[-1]['timestamp'] / 1000).strftime("%d/%m/%Y %H:%M"))
print()
...
plt.plot(trades_df['date'], trades_df['amount'].__round__(5))
